...
JuliEngine::Texture TextureImporter::LoadTexture(const char* path, bool invertImage)
{
	...
	return JuliEngine::Texture{ textureId, (float)textureWidth, (float)textureHeight, "", "" };
}
